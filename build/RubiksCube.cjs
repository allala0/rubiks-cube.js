...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ src_RubiksCube)
});

;// CONCATENATED MODULE: external "THREE"
const external_THREE_namespaceObject = require("THREE");
;// CONCATENATED MODULE: ./node_modules/three/examples/jsm/geometries/RoundedBoxGeometry.js


const _tempNormal = new external_THREE_namespaceObject.Vector3();
...
class RoundedBoxGeometry extends external_THREE_namespaceObject.BoxGeometry {
	...
	constructor( width = 1, height = 1, depth = 1, segments = 2, radius = 0.1 ) {
		...
		const position = new external_THREE_namespaceObject.Vector3();
		const normal = new external_THREE_namespaceObject.Vector3();

		const box = new external_THREE_namespaceObject.Vector3( width, height, depth ).divideScalar( 2 ).subScalar( radius );
		...
		const faceDirVector = new external_THREE_namespaceObject.Vector3();
        ...
        for (var j = 0; j < this.cube[i].length; j++) {
          ...
          for (var k = 0; k < this.cube[i][j].length; k++) {
            ...
            for (var l = 0; l < this.cube[i][j][k].length; l++) {
              ...
              if (this.cube[i][j][k][l] != null) {
                tile = new external_THREE_namespaceObject.Mesh(new RoundedBoxGeometry(tile_size[0], tile_size[1], tile_size[2], 2, 1), new external_THREE_namespaceObject.MeshPhongMaterial({
            ...
            if (!all_null) {
              cubies_cubie = new external_THREE_namespaceObject.Mesh(new RoundedBoxGeometry(cubie_size, cubie_size, cubie_size, 1, 0.05), new external_THREE_namespaceObject.MeshPhongMaterial({
                color: 0x000000,
                transparent: true,
                opacity: this.opacity
              }));
...
exports.RubiksCube = __webpack_exports__["default"];
/******/ })()
;